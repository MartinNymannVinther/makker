 ...
 *
 * An Makker on the open internet with open registration is an Makker where a
...
export const INVITATION_HEADER = "x-makker-invitation";

/** Header carrying a workspace invitation's id: a colleague joining an existing workspace. */
export const TEAM_INVITATION_HEADER = "x-makker-team-invitation";

export const DEMO_HEADER = "x-makker-demo";
 ...
 * `x-makker-demo: 1` would have walked straight past SIGNUP=closed and
