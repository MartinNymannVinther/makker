...
/**
 * What a model call was for. `chat` is a line in a conversation, `title`
 * the name the model proposes for one, `document` the JSON behind an
 * export, `test` the connection test under Settings → AI.
 */
export type AiKind = "chat" | "title" | "document" | "test";
