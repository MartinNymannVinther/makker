 ...
 * plainly what a Makker without a model can and cannot do: flows can be
 * drawn, kept and exported, but nothing can run and nothing can be
 * proposed, and the buttons say so rather than fail.
 *
