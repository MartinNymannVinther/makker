...
const ROLES = ["makker_app", "makker_auth"] as const;

const PASSWORD_ENV: Record<(typeof ROLES)[number], string> = {
  makker_app: "MAKKER_APP_PASSWORD",
  makker_auth: "MAKKER_AUTH_PASSWORD",
};
...
async function main(): Promise<void> {
  ...
  // as its value. A role whose password is "set MAKKER_APP_PASSWORD" is a
